...
from resources.user import User, UserLogin, UserLogout, TokenRefresh, TokenRevoke
from resources.manifest import Manifest, ManifestFilter, ManifestNames, ManifestColumns, ManifestManual, ManifestAuthTest, ManifestBufferTest
...
api.add_resource(TokenRevoke, '/revoke')
api.add_resource(UserLogout, '/logout')
api.add_resource(ManifestBufferTest, '/manifest-buffer-test')
# manifest-manual
